...
class TreeNode
{
	public:
		...
		TreeNode<T> *GetChildNode(const TREE_NODE::ID &ChildID) { return &(this->_Children[ChildID]); }	// Gets child node
		...
		const T	&GetData() const { return this->_Data; }				// Gets data of this node
